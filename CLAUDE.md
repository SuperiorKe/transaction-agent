...
| UI | Vite + React + TS in `web/`, built to `web/dist` and served by FastAPI. Its design decisions and visual system (tokens, type, components) are in the root `DESIGN.md`, which stays at the root. |
